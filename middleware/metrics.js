...
module.exports = readmeio.metrics(process.env.API_KEY, req => ({
  ...
  // when users log into the documentation. See middleware/jwt.js
  // and the documentation: https://docs.readme.com/metrics/docs/showing-api-logs-to-users#section-enabling-api-logs-in-docs
  id: req.user,
  label: req.user,
  email: req.user,
}));
